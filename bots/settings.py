...
DISCORD_TOKEN_VELO_PRICING=os.environ["DISCORD_TOKEN_VELO_PRICING"]
...
VELO_TOKEN_ADDRESS=normalize_address(os.environ["VELO_TOKEN_ADDRESS"])

CONNECTOR_TOKENS_ADDRESSES=list(map(lambda a: normalize_address(a), os.environ["CONNECTOR_TOKENS_ADDRESSES"].split(",")))
