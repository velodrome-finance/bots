...
from .settings import DISCORD_TOKEN_VELO_PRICING, VELO_TOKEN_ADDRESS, STABLE_TOKEN_ADDRESS
...
async def main():
    ...
    bot = PriceBot(source_token=velo, target_token=usdc, intents=discord.Intents.default())
